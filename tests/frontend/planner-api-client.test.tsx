...
test('planner API client serializes request bodies and methods', async () => {
  ...
  assert.deepEqual(calls.map((call) => [call.url, call.init?.method ?? 'GET']), [
    ...
    ['/api/plans/plan_client_001', 'GET'],
    ['/api/plans/plan_client_001/constraints', 'PATCH'],
    ['/api/plans/plan_client_001/alternatives', 'POST'],
    ['/api/plans/plan_client_001/confirm', 'POST'],
    ['/api/plans/plan_client_001/execute', 'POST'],
    ['/api/plans/plan_client_001/recover', 'POST'],
    ['/api/traces/plan_client_001', 'GET'],
    ['/api/tool-schemas', 'GET'],
    ['/api/health', 'GET'],
  ]);
