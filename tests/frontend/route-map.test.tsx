...
function makeRouteFixture() {
  return {
    legs: [{ from: 'home', to: 'a_021', mode: 'walk' as const, duration_minutes: 8, distance_km: 0.6, route_summary: '步行到活动点' }],
    total_travel_minutes: 8,
    walking_distance_km: 0.6,
    drive_time_minutes: 0,
    polyline: { type: 'LineString' as const, coordinates: [[140.8824, 38.2601], [140.881, 38.261]] as Array<[number, number]> },
    provider: 'local',
  };
}
